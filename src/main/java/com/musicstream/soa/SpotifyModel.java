...
public class SpotifyModel {
	...
	public SpotifyModel(String name, ArrayList<String> title, ArrayList<String> urlCover, ArrayList<String> urlStream,
	...
	public SpotifyModel(String name, ArrayList<String> playlistName, ArrayList<String> playlistUrlCover) {
		this.name = name;
