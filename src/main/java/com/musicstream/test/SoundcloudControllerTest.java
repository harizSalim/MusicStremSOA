...
@WebIntegrationTest
public class SoundcloudControllerTest {
	...
	public void testScUserPlaylist() {
		Map<String, Object> scResponse = restTemplate.getForObject(
				"http://localhost:8080/scuserplaylists", Map.class);

		assertNotNull("Soundcloud User Playlists : ", scResponse);
	...
	public void testScUserSearch() {
		Map<String, Object> scResponse = restTemplate.getForObject(
				"http://localhost:8080/scuserplaylists"
						+ SearchPan.textField.getText(), Map.class);

		assertNotNull("Soundcloud Search : ", scResponse);
	...
	public void testScUserSearchStream() {
		Map<String, Object> scResponse = restTemplate.getForObject(
				"http://localhost:8080/scsearchtracksstream"
						+ SearchPan.textField.getText(), Map.class);

		assertNotNull("Soundcloud Search Stream : ", scResponse);
